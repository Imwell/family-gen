...
<div class="layui-layout layui-layout-admin" style="border-bottom: solid 5px #1aa094;">
            ...
            <ul class="layui-nav admin-header-item">
                ...
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        ...
                        <dd>
                            <a href="${pageContext.request.contextPath}/system/login/login"><i class="fa fa-sign-out" aria-hidden="true"></i> 注销</a>
                        </dd>
                    </dl>
                </li>
            </ul>
    ...
    <script>
        ...
        function openDbTask(){
            $("#mainFrame").attr("src","${pageContext.request.contextPath}/process/bus/index?status=1");
        }

        function selectMenu(id){
            window.location.href="${pageContext.request.contextPath}/main?parent_id="+id;
        }
...
//        }];
        ...
        function showUserInfo() {
            parent.layer.open({
                ...
                maxmin: true,
                type: 2,
                content: '${pageContext.request.contextPath}/system/user/toEdit?id=${loginUser.id}',
                area: ['800px', '500px']
            });
        }
