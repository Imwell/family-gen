...
<form class="layui-form" action="${pageContext.request.contextPath}/system/user/save" id="form">
    <div>
...
<script>
    ...
    function reloadData(id){
        ...
        $.ajax({
            type: "GET",
            url: "${pageContext.request.contextPath}/system/user/findList?organize_id="+id,
            dataType: "json",
    ...
    function searchUser(){
        ...
        $.ajax({
            type: "GET",
            url: "${pageContext.request.contextPath}/system/user/findList?login_name="+login_name+"&nickname="+nickname+"&organize_name="+organize_name+"&phone="+phone,
            dataType: "json",
            success: function (res) {
                if (res.success) {
                    var tt ='';
