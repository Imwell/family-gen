...
<form class="layui-form" action="${pageContext.request.contextPath}/system/organize/update" id="form">
    <table width="90%">
        <tr>
...
<script>
    layui.use(['form'], function(){
        ...
        form.on('submit(submit_form)', function(data){
            $.post("${pageContext.request.contextPath}/system/organize/update",data.field,function(res){
                if (res.success) {
