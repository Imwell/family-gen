...
<form class="layui-form" action="${pageContext.request.contextPath}/system/organize/save" id="form">
    <div>
...
<script>
    ...
    function reloadData(id){
        $.ajax({
            type: "GET",
            url: "${pageContext.request.contextPath}/system/organize/findList?parent_id="+id,
            dataType: "json",
    ...
    function searchOrg(){
        ...
        $.ajax({
            type: "GET",
            url: "${pageContext.request.contextPath}/system/organize/findList?name="+name+"&short_name="+short_name,
            dataType: "json",
            success: function (res) {
                if (res.success) {
                    var tt ='';
