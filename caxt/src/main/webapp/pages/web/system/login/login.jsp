...
<div class="login">
    ...
    <form method="post" action="${pageContext.request.contextPath}/system/login/login" class="layui-form" >
        ...
        layui.use(['form'], function() {
            ...
            form.on('submit(login)', function(data) {
                ...
                layer.alert(JSON.stringify(data.field), {
                    ...
                    location.href = "${pageContext.request.contextPath}/system/login/login";
                })
                return false;
            });
