...
<form class="layui-form" action="${pageContext.request.contextPath}/system/role/save" id="form">
<table width="90%">
    <tr>
...
<script>
    layui.use(['form'], function(){
        ...
        form.on('submit(submit_form)', function(data){
            $.post("${pageContext.request.contextPath}/system/role/save",data.field,function(res){
                if(res==1){
    ...
    function selectOneUser(){
        ...
        parent.layer.open({
            ...
            maxmin: true,
            type: 2,
            content: '${pageContext.request.contextPath}/system/user/selectOneUser?ids='+ids+'&names='+names,
            area: ['800px', '520px'],
            end: function () {
                getUser("ids","names");
            }
    ...
    function selectMoreUser(){
        ...
        parent.layer.open({
            ...
            maxmin: true,
            type: 2,
            content: '${pageContext.request.contextPath}/system/user/selectMoreUser?ids='+ids+'&names='+names,
            area: ['800px', '520px'],
            end: function () {
                getUser("ids","names");
            }
    ...
    function selectOneOrg(){
        ...
        parent.layer.open({
            ...
            maxmin: true,
            type: 2,
            content: '${pageContext.request.contextPath}/system/organize/selectOneOrg?ids='+ids+'&names='+names,
            area: ['800px', '520px'],
            end: function () {
                getOrg("ids","names");
            }
    ...
    function selectMoreOrg(){
        ...
        parent.layer.open({
            ...
            maxmin: true,
            type: 2,
            content: '${pageContext.request.contextPath}/system/organize/selectMoreOrg?ids='+ids+'&names='+names,
            area: ['800px', '520px'],
            end: function () {
                getOrg("ids","names");
            }
    ...
    function selectOrgUser(){
        ...
        parent.layer.open({
            ...
            maxmin: true,
            type: 2,
            content: '${pageContext.request.contextPath}/system/organize/selectOrgUser?ids='+ids+'&names='+names,
            area: ['800px', '520px'],
            end: function () {
                getOrg("ids","names");
            }
