...
<script type="text/javascript">
    ...
    $(document).ready(function (){
        var treeNodes = '';
        $.ajax({
            url : "${pageContext.request.contextPath}/system/role/findRoleMenuList?role_id=${pd.role_id}",
            data : {},
            type : 'GET',
            dataType : 'json',
...
//                alert('Sorry, there was a problem!');
    ...
    layui.use(['form'], function(){
        ...
        form.on('submit(submit_form)', function(data){
            ...
            $.post("${pageContext.request.contextPath}/system/role/saveRoleMenu",data.field,function(res){
                if (res.success) {
