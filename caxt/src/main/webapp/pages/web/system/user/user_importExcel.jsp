...
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/plugins/layui/layui.js"></script>
	...
	<script type="text/javascript">
        layui.use(['form','upload'], function(){
            ...
            upload.render({
                elem: '#test1'
                ,url: '${pageContext.request.contextPath}/common/upload/uploadUserFile'
                ,auto: true
                ,multiple: true
                ,accept:'file'
                ,done: function(res){
        ...
        function save(){
            ...
            if(file_id == null || file_id == ''){
                ...
                $.ajax({
                    ...
                    url: "${pageContext.request.contextPath}/system/user/saveImportExcel" ,//url
                    data: $('#form').serialize(),
        ...
        function delFile(id,file_path){
            $.ajax({
                type: "GET",//方法类型
                dataType: "json",//预期服务器返回的数据类型
                url: "${pageContext.request.contextPath}/common/upload/delUserFile?id="+id+"&file_path="+file_path,//url
                data: "",
                success: function (res) {
                    if (res.success) {
                        $("#div_upload").html("");
