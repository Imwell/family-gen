...
<script>
    ...
    layui.use('table', function(){
        ...
        table.render({
            elem: '#LAY_table_menu'
            ,url: '${pageContext.request.contextPath}/system/menu/findListPage?auth_type=${pd.auth_type}&auth_organize_ids=${pd.auth_organize_ids}'
                ,cols: [[
        ...
        $('#dels').on('click',function (){
            ...
            if(data.length>0){
                layer.confirm('删除数据会同步删除下级数据，是否进行删除操作？', function(index){
                    ...
                    $.get("${pageContext.request.contextPath}/system/menu/del?ids="+ids,null,function(res){
                        if (res.success) {
        ...
        if(parent_id==''||parent_id==null){
            ...
            if(curr_type=='button'){
                ...
                parent.layer.open({
                    ...
                    maxmin: true,
                    type: 2,
                    content: '${pageContext.request.contextPath}/system/menu/toAdd?parent_id='+parent_id+'&name='+name+'&level='+level+'&menu_cascade='+menu_cascade+'&type='+type,
                    area: ['800px', '500px'],
                    end: function () {
                        location.reload();
                    }
        ...
        if(parent_id==''||parent_id==null){
            ...
            if(curr_type=='button'){
                ...
                parent.layer.open({
                    ...
                    maxmin: true,
                    type: 2,
                    content: '${pageContext.request.contextPath}/system/menu/toAddMore?parent_id='+parent_id+'&name='+name+'&level='+level+'&menu_cascade='+menu_cascade+'&type='+type,
                    area: ['1000px', '500px'],
                    end: function () {
                        location.reload();
                    }
    ...
    function edit(id,type){
        parent.layer.open({
            ...
            maxmin: true,
            type: 2,
            content: '${pageContext.request.contextPath}/system/menu/toUpdate?id='+id+'&type='+type+'&level='+$("#tree_level").val(),
            area: ['800px', '500px'],
            end: function () {
                location.reload();
            }
    ...
    function info(id,type){
        parent.layer.open({
            ...
            maxmin: true,
            type: 2,
            content: '${pageContext.request.contextPath}/system/menu/findInfo?id='+id+'&type='+type,
            area: ['800px', '500px']
        });
    }
