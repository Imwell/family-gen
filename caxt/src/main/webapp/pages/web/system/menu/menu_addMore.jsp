...
<form class="layui-form" action="${pageContext.request.contextPath}/system/menu/save" id="form">
...
//            })
            ...
            <%--$.post("${pageContext.request.contextPath}/system/menu/saveMore",data.field,function(res){--%>
                <%--layer.msg("数据保存成功。", {time: 2000});--%>
