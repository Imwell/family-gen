...
<form class="layui-form" action="${pageContext.request.contextPath}/gen/family/update" id="form">
    <table width="90%">
        <tr>
...
<script>
    layui.use(['form'], function(){
        ...
        form.on('submit(submit_form)', function(data){
            $.post("${pageContext.request.contextPath}/gen/family/update",data.field,function(res){
                if (res.success) {
