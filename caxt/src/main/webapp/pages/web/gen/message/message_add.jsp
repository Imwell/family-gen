...
<form class="layui-form" action="${pageContext.request.contextPath}/gen/message/save" id="form">
<table width="90%">
    <tr>
...
<script>
    layui.use(['form'], function(){
        ...
        form.on('submit(submit_form)', function(data){
            $.post("${pageContext.request.contextPath}/gen/message/save",data.field,function(res){
                if (res.success) {
