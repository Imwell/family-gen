...
<form class="layui-form" action="${pageContext.request.contextPath}/gen/member/save" id="form">
<table width="90%">
    <tr>
    ...
    <tr>
        ...
        <td colspan="3">
            ...
            <input type="radio" name="self" value="0" title="否" checked>
        </td>
    </tr>
    <tr>
...
<script>
    ...
    layui.use(['form'], function(){
        ...
        form.on('select(selectFamily)', function (data) {
            selectFamily()
            return false;
        })
